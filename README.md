...
- `gptollama`: `GPT-5.4 + local Ollama gemma3:12b`
...
- Heavy reasoning agents: `openai/gpt-5.4`
- Quick / research / worker lanes: `ollama/gemma3:12b`
...
- `status` checks whether `ollama/gemma3:12b` or `glm-5.1` appears in the active config
...
- includes local `ollama` provider entry for `gemma3:12b`
